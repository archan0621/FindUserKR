...
printf "\e[1;77m      \/            \/      \/             \/     \/       \e[0m\n"
printf "\n"
printf "\e[1;93m .:.:.\e[0m\e[1;77m v1.2 FindUser coded by: @Hak9  recover by: @Archan\e[0m\e[1;93m.:.:.\e[0m\n"
printf "\n"
...
check_naver=$(curl -s -H "Accept-Language: en" "https://www.naver.com/$username" -L | grep -o 'The link you followed may be broken'; echo $?)
printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] Naver: \e[0m"

if [[ $check_naver == *'1'* ]]; then
printf "\e[1;92m Found!\e[0m https://www.naver.com/%s\n" $username
printf "https://www.naver.com/%s\n" $username > $username.txt
elif [[ $check_naver == *'0'* ]]; then
printf "\e[1;93mNot Found!\e[0m\n"
fi

## Daum

check_daum=$(curl -s -H "Accept-Language: en" "https://www.daum.net/$username" -L | grep -o 'The link you followed may be broken'; echo $?)
printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] Daum: \e[0m"

if [[ $check_daum == *'1'* ]]; then
printf "\e[1;92m Found!\e[0m https://www.daum.net/%s\n" $username
printf "https://www.daum.net/%s\n" $username > $username.txt
elif [[ $check_daum == *'0'* ]]; then
printf "\e[1;93mNot Found!\e[0m\n"
fi
